...
const AIChatWidget = () => {
  ...
  return (
    <div className="ai-widget-wrapper">
      ...
      {/* Chat window overlay (unconditional rendering for CSS transition support) */}
      <div className={`ai-chat-window glass-panel ${isOpen ? 'open' : ''} ${isMaximized ? 'maximized' : ''}`}>
